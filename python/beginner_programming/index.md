...
### 演習問題
1. これから学習を進めるにあたってやたらめったら作っていてはファイルが乱雑に散らかってしまって後から手入れがしにくいです。きちんとディレクトリを作成してまとめましょう。それではPyCharmで、以下のようなファイル構造になるようにKoyoPythonLectureの中を整理してください。PyCharmであるディレクトリAの中にディレクトリBを作りたければディレクトリAを右クリックしてからNew Directoryを選べばOKです。


2. 以下のように3行の文章を表示してください。
